...
function Home() {
  return (
    <>
      ...
      <h3 className="parag">
        Royal-Tee is an online clothing shop but with a little twist. You can
        design and customise your own outfit, and after making your order , we
        will review your design and make it available for the other customers to
        buy . Why us ? Because we give back to our community by offering
